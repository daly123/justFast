...
<div class="container">
	<div class="row">
		<div class="col-xs-12 col-md-6 col-md-offset-3">
			<h2>Reclamez vous</h2>
			<form novalidate="novalidate" class="simple_form new_user" id="new_user" action="/account" accept-charset="UTF-8" method="post">
				...
				<div class="form-group string required user_user_preference_birth_date">
					<label class="string required control-label" for="user_user_preference_attributes_birth_date" required="true">* Tel</label>
					<input class="string required input-lg form-control" placeholder="" value="" type="text" name="user[user_preference_attributes][birth_date]" id="user_user_preference_attributes_birth_date">
				</div>
				<div class="form-group email required user_email">
					<label class="email required control-label" for="user_email" required="true">* Adresse email</label>
					<input class="string email required input-lg form-control" type="email" value="" name="user[email]" id="user_email">
				</div>
				<div class="form-group tel required user_phone">
					<label class="tel required control-label" for="user_phone"required="true">* Numéro de téléphone portable</label>
					<input class="string tel required input-lg form-control" type="tel" name="user[phone]" id="user_phone">
				</div>
				<div id="user_city_form" class="form-group string required user_city">
					<label class="string required control-label" for="user_city"required="true">* Objet de la reclamation</label>
					<input class="string required input-lg form-control" type="text" value="" name="user[city]" id="user_city" placeholder="" autocomplete="off">
				</div>
				<div class="form-group password required user_password">
					<label class="password required control-label" for="user_password" required="true">* Description</label>
					<div class="password">
                        <textarea class="string required input-lg form-control"  cols="40" rows="10" value="" name="user[city]" id="description" placeholder=""></textarea>
				...
				<div class="form-group pull-right">
					<input type="submit" name="commit" value="Envoyer" class="btn btn-success btn-lg">
				</div>
				<br><br><br>
			</form>
		</div>
